...
$filter_merkez_adresi = ((strlen($row->merkez_adresi) > 50) ? mb_substr($row->merkez_adresi, 0, 40) . '...': $row->merkez_adresi) ;
            ...
            $data[] = [ 
              ...
              .($row->takas_cihaz_mi != 0 ? '<br><div style="  background: #ffb7001c;border: 1px solid #ff9d00;border-radius: 3px;padding: 2px;color: #d23100; "><i class="fas fa-times-circle"></i><b style="font-weight: 490;"> TAKAS CİHAZI </b></div>' : ""),
