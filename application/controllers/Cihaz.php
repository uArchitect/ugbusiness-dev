...
function cihaz_havuz_stok_sil($stok_id = 0) { 
    ...
    if($stok_id != 0){
      ...
      function cihaz_havuz_liste_view() { 
       ...
       $this->db->join("urunler", "cihaz_havuzu.cihaz_kayit_no = urunler.urun_id COLLATE utf8mb3_general_ci");
$this->db->join("urun_renkleri", "cihaz_havuzu.cihaz_renk_no = urun_renkleri.renk_id COLLATE utf8mb3_general_ci");
$this->db->join("siparis_urunleri", "siparis_urunleri.seri_numarasi = cihaz_havuzu.cihaz_havuz_seri_numarasi COLLATE utf8mb3_general_ci", "left");
$this->db->join("siparisler", "siparis_urunleri.siparis_kodu = siparisler.siparis_id COLLATE utf8mb3_general_ci", "left");
$this->db->join("merkezler", "siparisler.merkez_no = merkezler.merkez_id COLLATE utf8mb3_general_ci", "left");
$this->db->join("musteriler", "merkezler.merkez_yetkili_id = musteriler.musteri_id COLLATE utf8mb3_general_ci", "left");

        
          $viewData["cihazlar"] = $this->db->get("cihaz_havuzu")->result();
