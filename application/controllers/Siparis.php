	...
	public function sms_gonderilen_siparisler() { 
	   ...
	   $query = $this->db
        ...
        foreach ($rr as $row) {
            ...
            $data[] = [
                '<b><a href="" class="btn btn-warning btn-xs">TEKRAR SMS GÖNDER</a><br><a href="" onclick="showWindow(\''.$urlcustom.'\');">'.$row->siparis_kodu.'</a></b><br><span style="font-weight:normal">'.date('d.m.Y H:i',strtotime($row->kayit_tarihi)).'</span>',
