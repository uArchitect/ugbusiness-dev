	   ...
	   $query = $this->db
        ...
        foreach ($rr as $row) {
            ...
            $data[] = [
				...
				($row->degerlendirme_soru_4 > 0 ? "<span>".($row->degerlendirme_oneri != "" ? $row->degerlendirme_oneri : "<span style='opacity:0.5'>$row->musteri_ad adlı müşteri tarafından öneri bilgisi girilmemiştir.</span>") ."</span>" : "<span style='opacity:0.5'>Beklemede</span>")
