	...
	public function tamamlanmayanlar_ajax() { 
	   ...
	   $query = $this->db
        ...
        foreach ($query->result() as $row) {
            ...
            $data[] = [
                "<b onclick='showWindow(\"".$urlcustom."\");'>".$row->siparis_kodu."</b><br><span style='font-weight:normal'>".date('d.m.Y H:i',strtotime($row->kayit_tarihi))."</span><br>".$row->kullanici_ad_soyad,
