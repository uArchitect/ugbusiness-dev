	...
	public function tamamlanmayanlar_ajax() {
		...
		foreach ($query->result() as $row) {
			...
			$data[] = [
				...
				"<b>$musteri</b><br><span style='font-weight:normal'>İletişim : " . formatTelephoneNumber($row->musteri_iletisim_numarasi) . "</span><br>$durum".'<br><span class="text-orange" style="width: 354px; text-wrap: auto; display: block;">'.$row->siparis_gorusme_aciklama.'</span>',
