	   ...
	   $query = $this->db
        ...
        foreach ($query->result() as $row) {
            ...
            $data[] = [
				...
				"<b>".$row->merkez_adi."</b><span style='font-weight:normal'> / ".$row->sehir_adi." (".$row->ilce_adi.")"."</span><br>".(($row->merkez_adresi != "" || $row->merkez_adresi != "." || $row->merkez_adresi != "0") ? "<span style='font-weight:normal'>".$row->merkez_adresi."</span>" : '<span style="opacity:0.4;font-weight:normal">BU MERKEZE TANIMLI ADRES KAYDI BULUNAMADI</span>' ),
