	...
	public function siparisler_ajax() { 
	   ...
	   $query = $this->db
        ...
        foreach ($query->result() as $row) {
			...
			$musteri = '<a style="color:black;font-weight: 500;" href="https://ugbusiness.com.tr/musteri/profil/'.$row->musteri_id.'"><i class="fa fa-user-circle" style="color: #035ab9;"></i> '.$row->musteri_ad.'</a>';     
