	...
	public function tamamlanmayanlar_ajax() {
		...
		foreach ($query->result() as $row) {
			...
			if($yenilenmis_cihaz_var_mi>0){
				$musteri .= "<span style='margin-left: 10px; border-radius: 6px; padding: 5px; padding-bottom: 2px; padding-top: 2px;' class='bg-success '>".$yenilenmis_cihaz_var_mi." x Yenilenmiş Cihaz";
			}
