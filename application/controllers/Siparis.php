	   ...
	   $query = $this->db
        ...
        foreach ($rr as $row) {
            ...
            $data[] = [
				...
				($row->degerlendirme_soru_1 > 0 ? "<span class='btn btn-$color1 btn-xs' tooltip='Teknik servis ekibimizin size karşı hitap ve davranışlarını değerlendirin.' style='display: block;margin:auto;margin-top:5px;width:25px;'>".$row->degerlendirme_soru_1."</span>" : "<span style='opacity:0.5'>Beklemede</span>"),
				($row->degerlendirme_soru_2 > 0 ? "<span class='btn btn-$color2 btn-xs' tooltip='Eğitmenin size karşı hitap ve davranışlarını değerlendirin.' style='display: block;margin:auto;margin-top:5px;width:25px;'>".$row->degerlendirme_soru_2."</span>" : "<span style='opacity:0.5'>Beklemede</span>"),
				($row->degerlendirme_soru_3 > 0 ? "<span class='btn btn-$color3 btn-xs' tooltip='Sorularınız net ve eksiksiz cevaplandı mı?' style='display: block;margin:auto;margin-top:5px;width:25px;'>".$row->degerlendirme_soru_3."</span>" : "<span style='opacity:0.5'>Beklemede</span>"),
				($row->degerlendirme_soru_4 > 0 ? "<span class='btn btn-$color4 btn-xs' tooltip='Bizi tavsiye eder misiniz?' style='display: block;margin:auto;margin-top:5px;width:25px;'>".$row->degerlendirme_soru_4."</span>" : "<span style='opacity:0.5'>Beklemede</span>"),
