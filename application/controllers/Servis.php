...
public function servis_bildirim_guncelle($servis_id = 0,$guncellenecek_bildirim = 0)
	...
	public function servisler_ajax() { 
		...
		$query = $this->db
		->select("servisler.servis_id,servisler.servis_kayit_tarihi,servisler.servis_guncelleme_tarihi,servisler.servis_kod,urun_renkleri.renk_adi,kullanicilar.kullanici_ad_soyad,   borclu_cihazlar.borc_durum as cihaz_borc_uyarisi,siparis_urunleri.siparis_urun_id,urunler.urun_adi,servis_durum_kategorileri.servis_durum_kategori_adi,sehirler.sehir_adi,ilceler.ilce_adi,siparis_urunleri.seri_numarasi,siparis_urunleri.garanti_baslangic_tarihi,siparis_urunleri.garanti_bitis_tarihi,merkezler.*,musteriler.musteri_ad,musteriler.musteri_iletisim_numarasi,musteriler.yetkili_adi_2,musteriler.yetkili_iletisim_2,musteriler.musteri_id")
		->from('servisler')
