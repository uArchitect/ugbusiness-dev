...
$query = $this->db->query($sql);
	...
	{   
            ...
            where (kullanicilar.kullanici_departman_id = 12 or kullanicilar.kullanici_departman_id = 17 or kullanicilar.kullanici_departman_id = 18) and siparisler.siparis_aktif = 1 ORDER BY siparisler.kayit_tarihi desc";
            $query = $this->db->query($sql);
            $viewData["kullanicilar"] = $query->result(); 
