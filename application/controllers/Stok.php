...
public function get_stok_kayitlari_ajax() {
    ...
    $this->db->select('sh.stok_id,sh.stok_seri_kod,sh.stok_cikis_yapildi,sh.stok_kayit_tarihi,sh.qr_durum,sh.stok_cikis_tarihi,sh.stok_giris_tarihi,sh.tanimlanan_cihaz_seri_numarasi st.*, spr.seri_numarasi, ust_grup.stok_tanim_ad AS ust_grup_ad');
...
$alt_urunler = $this->Stok_model->stok_kayitlari_all(["stok_ust_grup_kayit_no"=>$stok_tanim->stok_id]);
        ...
        $row['stok_tanim_ad'] = "<a href='https://ugbusiness.com.tr/stok_tanim/index/$stok_tanim->stok_id' style='".(count($alt_urunler)>0 ? "color:white" : "color:black")."' target='_blank'>".(count($alt_urunler)>0 ? "".$stok_tanim->stok_tanim_ad."" : "".$stok_tanim->stok_tanim_ad)."</a>".($stok_tanim->cikma_parca_mi ? '<span style="height: 19px;padding: 5px; margin-left: 4px;" class="badge bg-warning"> 2. El Parça</span>' : '').($stok_tanim->stok_tanim_aciklama != "" ? "<br><span style='opacity:0.6'>$stok_tanim->stok_tanim_aciklama</span>" : "");
...
if(count($alt_urunler)>0){
    foreach ($alt_urunler as $stok_tanim_alt) {
        ...
        $row['stok_tanim_ad'] = '<a href="https://ugbusiness.com.tr/stok_tanim/index/'.$stok_tanim_alt->stok_id.'"  style="color:#004710" target="_blank">'.'<span class="text-success"><i class="fas fa-arrow-circle-right" style="color:#004710"></i></span> '.$stok_tanim_alt->stok_tanim_ad."</a>".($stok_tanim->cikma_parca_mi ? '<span style="height: 19px;padding: 5px; margin-left: 4px;" class="badge bg-warning"> 2. El Parça</span>' : '');
