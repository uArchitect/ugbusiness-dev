...
$alt_urunler = $this->Stok_model->stok_kayitlari_all(["stok_ust_grup_kayit_no"=>$stok_tanim->stok_id]);
        ...
        $row['stok_tanim_ad'] = "<a href='https://ugbusiness.com.tr/stok_tanim/$stok_tanim->stok_id' target='_blank'>".(count($alt_urunler)>0 ? "".$stok_tanim->stok_tanim_ad."" : "".$stok_tanim->stok_tanim_ad)."</a>".($stok_tanim->cikma_parca_mi ? '<span style="height: 19px;padding: 5px; margin-left: 4px;" class="badge bg-warning"> 2. El Parça</span>' : '');
...
if(count($alt_urunler)>0){
    foreach ($alt_urunler as $stok_tanim_alt) {
        ...
        $row['stok_tanim_ad'] = '<a href="https://ugbusiness.com.tr/stok_tanim/'.$stok_tanim_alt->stok_id.'" target="_blank">'.'<span class="text-success"><i class="fas fa-arrow-circle-right" style="color:#004710"></i></span> '.$stok_tanim_alt->stok_tanim_ad."</a>".($stok_tanim->cikma_parca_mi ? '<span style="height: 19px;padding: 5px; margin-left: 4px;" class="badge bg-warning"> 2. El Parça</span>' : '');
