...
public function get_stok_kayitlari_ajax() {
    ...
    $this->db->where("sh.stok_ust_grup_kayit_no",0)->select('sh.stok_id,sh.stok_ust_grup_kayit_no,sh.cikma_parca_mi,sh.stok_cop_mu,sh.stok_seri_kod,sh.stok_cikis_yapildi,sh.stok_kayit_tarihi,sh.qr_durum,sh.stok_cikis_tarihi,sh.tanimlanan_cihaz_seri_numarasi, st.*');
