...
if(count($alt_urunler)>0){
    foreach ($alt_urunler as $stok_tanim_alt) {
        ...
        $row['stok_seri_kod'] = "<span onclick='serikoddegistir(\"$stok_tanim_alt->stok_id\",\"$stok_tanim_alt->stok_seri_kod\");' >".$stok_tanim_alt->stok_seri_kod."</span>" ?: "<span style='opacity:0.5;'>Seri Kod Tanımlanmadı</span>";
