    ...
    public function musteriler_ajax() {
        ...
        foreach ($query->result() as $row) {
            $data[] = [
                ...
                '<a style="background:#ffffff!important;" href="https://ugbusiness.com.tr/cihaz/cihaz_tanimlama_view/'.$row->musteri_id.'" class="btn btn-xs btn-warning"><i class="fa fa-plus-circle"></i> Cihaz Tanımla</a>
