 ...
 <div class="container-fixed" id="content_container">
	...
	.dark .hero-bg {
     ...
     <div class="bg-center bg-cover bg-no-repeat hero-bg">
      ...
      <div class="container-fixed">
       <div class="flex flex-col items-center gap-2 lg:gap-3.5 py-4 lg:pt-5 lg:pb-10">
        <img class="rounded-full border-3 border-success size-[100px] shrink-0" src="<?=base_url()?>/ugajansassets/assets/media/avatars/300-14.png"/>
        ...
        <div class="dropdown" data-dropdown="true" data-dropdown-placement="bottom-end" data-dropdown-placement-rtl="bottom-start" data-dropdown-trigger="click">
         ...
         <div class="dropdown-content menu-default w-full max-w-[220px]">
          <div class="menu-item" data-dropdown-dismiss="true">
           <button class="menu-link" data-modal-toggle="#update_profile_modal">
     ...
     <div class="modal" data-modal="true" data-modal-disable-scroll="false" id="update_profile_modal">
   <div class="modal-content max-w-[500px] top-5 lg:top-[15%]">
    ...
    <div class="text-2sm text-brand mt-0 " style="margin-top:-10px;margin-bottom:10px">
           Müşteri bilgilerini güncellemek için Müşteri Ad Soyad ve İletişim Numarası alanları zorunludur. İşletme bilgileri müşteri profili oluşturulduktan sonra girilebilir.
      ...
      <label class="input">
       <input type="text" required placeholder="Müşteri adını soyadını giriniz" value="<?=$musteri_data->musteri_ad_soyad?>" name="musteri_ad_soyad"  >
     ...
     <div class="flex flex-col px-5 gap-2.5">
      ...
      <label class="input">
       <input type="text" required name="musteri_iletisim_numarasi"  value="<?=$musteri_data->musteri_iletisim_numarasi?>"  placeholder="İletişim numarası giriniz"   >
     ...
     <div class="flex flex-col px-5 gap-2.5">
      ...
      <label class="input">
       <input type="text" name="musteri_email_adresi"  value="<?=$musteri_data->musteri_email_adresi?>"  placeholder="Email adresi giriniz"   >
