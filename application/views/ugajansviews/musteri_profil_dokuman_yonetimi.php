...
<?php
        ...
        <div class="card-body flex flex-col items-center gap-2.5 py-7.5">
         <div class="flex justify-center p-7.5 py-9">
          <img alt="image" class="dark:hidden max-h-[230px]" src="http://localhost/ugajans/assets/media/illustrations/22.svg">
          <img alt="image" class="light:hidden max-h-[230px]" src="http://localhost/ugajans/assets/media/illustrations/22-dark.svg">
         </div>
            ...
            <div class="flex items-center gap-3">
             <div class="flex items-center grow gap-2.5">
              ...
              <i class="ki-filled ki-down" style="color:green">
               ...
               <a class="btn btn-sm btn-light btn-outline text-center  " href="<?=base_url("musteri/musteri_dokuman_sil/$musteri_data->musteri_id/$dokuman->dokuman_id")?>">
