...
<?php 
           ...
           ?>
  <a href="<?=($sosyal_medya->sosyal_medya_url != "") ? $sosyal_medya->sosyal_medya_url : "https://ugbusiness.com.tr/ugajans_musteri/profil/$musteri_data->musteri_id"?>" target="_blank" rel="noopener noreferrer">
