      ...
      <div class="flex flex-wrap items-center lg:items-end justify-between gap-5 pb-7.5">
       <div class="flex flex-col justify-center gap-2">
        ...
        <div class="flex items-center gap-2 text-sm font-normal text-gray-700">
         Tüm ug ajans kullanıcıları listelenmiştir. 
        </div>
       </div>
       ...
       <div class="card card-grid min-w-full">
        <div class="card-header flex-wrap gap-2">
         <h3 class="card-title font-medium text-sm">
          Toplam <?=count($kullanicilar_data)?> adet kullanici listelenmiştir.
         </h3>
         <div class="flex flex-wrap gap-2 lg:gap-5">
          <div class="flex">
           <label class="input input-sm">
            ...
            <input placeholder="Kullanıcı Ara..." type="text" value="">
            </input>
           </label>
          </div>
           ...
           <table class="table table-auto table-border"  >
            ...
            <tbody>
             ...
             <tr>
              ...
              <td>
               <div class="flex items-center gap-2.5">
                <img alt="" class="rounded-full size-7 shrink-0" src="<?=base_url()?>/ugajansassets/assets/media/avatars/300-<?=$musteri->musteri_id?>.png"/>
