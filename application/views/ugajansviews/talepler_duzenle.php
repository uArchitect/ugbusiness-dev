      ...
      <div class="flex flex-wrap items-center lg:items-end justify-between gap-5 pb-7.5">
       <div class="flex flex-col justify-center gap-2">
        ...
        <div class="flex items-center gap-2 text-sm font-normal text-gray-700">
         Talep bilgilerini güncellemek için aşağıdaki formu doldurunuz.
        </div>
       </div>
            ...
            <div class="card pb-2.5">
              ...
              <div class="card-body grid gap-5">
                ...
                <div class="flex items-center flex-wrap lg:flex-nowrap gap-2.5">
                  ...
                  <div class="grow">
                   <input class="input" name="talep_ad_soyad" placeholder="Müşteri Adı Soyadı" type="text" value="<?=$edit_talep->talep_ad_soyad?>" required>
                  </div>
                </div>
                ...
                <div class="flex items-center flex-wrap lg:flex-nowrap gap-2.5">
                  ...
                  <div class="grow">
                   <input class="input" name="talep_iletisim_numarasi" placeholder="İletişim Numarası" type="text" value="<?=$edit_talep->talep_iletisim_numarasi?>" required>
                  </div>
                </div>
                ...
                <div class="flex items-center flex-wrap lg:flex-nowrap gap-2.5">
                  ...
                  <div class="grow">
                   <input class="input" name="talep_email_adresi" placeholder="Email Adresi" type="email" value="<?=$edit_talep->talep_email_adresi?>">
                  </div>
                </div>
                ...
                <div class="flex items-center flex-wrap lg:flex-nowrap gap-2.5">
                  ...
                  <div class="grow">
                   <select class="select" name="talep_kaynak_no" required>
                      ...
                      ?>
                      <option value="<?=$tk->ugajans_talep_kaynak_id?>" <?=$edit_talep->talep_kaynak_no == $tk->ugajans_talep_kaynak_id ? "selected" : ""?>>
                ...
                <div class="flex items-center flex-wrap lg:flex-nowrap gap-2.5">
                  ...
                  <select class="select" name="talep_kategori_no" required>
                      ...
                      ?>
                      <option value="<?=$tk->talep_kategori_id?>" <?=$edit_talep->talep_kategori_no == $tk->talep_kategori_id ? "selected" : ""?>>
                ...
                <div class="flex items-start flex-wrap lg:flex-nowrap gap-2.5">
                  ...
                  <div class="grow">
                 <textarea class="input" name="talep_gorusme_detaylari" style="height:150px" placeholder="Görüşme detaylarını buraya yazabilirsiniz..."><?=$edit_talep->talep_gorusme_detaylari?></textarea>
                  </div>
                </div>
