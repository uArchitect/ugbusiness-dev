...
foreach ($kullanicilar as $kdata) {
    ?>
      ...
      <label class=" col-4 btn btn-default " style=" <?=($kdata->kullanici_id == 5 || $kdata->kullanici_id == 18 || $kdata->kullanici_id == 19) ? "border:2px solid darkgreen;" : "opacity:0.6!important"?>   align-content: center;
width:31%;border-radius:2px;">
        <input type="radio" required name="yonlenen_kullanici_id" style=" <?=($kdata->kullanici_id == 5 || $kdata->kullanici_id == 18 || $kdata->kullanici_id == 19) ? "" :"opacity:0.6!important" ?>" id="option_k<?=$kdata->kullanici_id?>" value="<?=$kdata->kullanici_id?>" autocomplete="off">
