...
<?php
      ...
      <div class="form-group col pl-0">
        ...
        <input type="text" value="<?php echo  !empty($talep) ? $talep->talep_musteri_ad_soyad : '';?>" class="form-control" name="talep_musteri_ad_soyad" required="" placeholder="Müşteri Ad Soyad Giriniz..." autofocus="">
      </div>

      <div class="form-group col pr-0">
        <label for="formClient-Code"> Merkez / İşletme Adı</label>
        <input type="text" value="<?php echo !empty($talep) ? $talep->talep_isletme_adi : '';?>" class="form-control" name="talep_isletme_adi" placeholder="İşletme Adını Giriniz..." autofocus="">
      </div>
...
<br>
 ...
 <div class="form-group" id="gorusme_detay">
        ...
        <label for="formClient-Name" style="font-weight:normal;  opacity:0.5; ">(*Zorunlu)</label>
        <textarea name="gorusme_detay" id="summernote8"><?php if(!empty($talep_yonlendirme)){echo $talep_yonlendirme->gorusme_detay;}?></textarea>
      </div>
...
<div class="card card-dark <?=(aktif_kullanici()->kullanici_id == 1 || aktif_kullanici()->kullanici_id == 9) ? "" : "d-none"?>">
    <div class="card-header with-border">
