                ...
                <section class="content col-12 <?=(aktif_kullanici()->kullanici_id == 1 || aktif_kullanici()->kullanici_id == 9 || aktif_kullanici()->kullanici_id == 4 || aktif_kullanici()->kullanici_id == 6) ? "col-xl-8 col-lg-10" : "col-xl-10 col-lg-12" ?>">
                  <div class="card card-primary">
                    <div class="card-header with-border" style="background:#00264f!important;">
                      <h3 class="card-title">
                        <button id="backButton" style="display:none;"><i class="fa fa-arrow-circle-left"></i> Geri Git</button>
                        Talep Bilgileri
                      </h3>
                    </div>
                                ...
                                <?php foreach($kaynaklar as $kaynak) : ?>
                                  <?php 
                                    if(aktif_kullanici()->kullanici_id == 1){
                                      if(empty($talep)){
                                        ?> 
                                          <option <?php echo (empty($talep) && $kaynak->talep_kaynak_id == 1 && (aktif_kullanici()->kullanici_id == 1 || aktif_kullanici()->kullanici_id == 4)) ? 'selected="selected"' : '' ?> data-icon="<?=$kaynak->talep_kaynak_resim?>" value="<?=$kaynak->talep_kaynak_id?>"><?=$kaynak->talep_kaynak_adi?></option>
                                        <?php
                                      }else{
                                        ?>
                                      ...
                                      if(empty($talep)){
                                        ?> 
                                          <option <?php echo ($kaynak->talep_kaynak_id == 6) ? 'selected="selected"' : '';?> data-icon="<?=$kaynak->talep_kaynak_resim?>" value="<?=$kaynak->talep_kaynak_id?>"><?=$kaynak->talep_kaynak_adi?></option>
                                        <?php
                                      }else{
                                        ?>
                                          <option data-icon="<?=$kaynak->talep_kaynak_resim?>" value="<?=$kaynak->talep_kaynak_id?>" <?php echo ($talep->talep_kaynak_no == $kaynak->talep_kaynak_id) ? 'selected="selected"' : '';?>><?=$kaynak->talep_kaynak_adi?></option>
                    ...
                    <div class="card-footer">
                      <div class="row">
                        ...
                        <a href="<?=base_url("bekleyen-talepler")?>" style="flex:1" class="btn btn-danger"><i class="fas fa-times"></i> İptal</a>
                      </div>
                    </div>
                    <!-- /.card-footer-->
                      ...
                      <tbody>
                        <?php $count=0; foreach ($yonlendirmeler as $talep) : ?>
                          ...
                          <tr style="background:<?=$background?>;">
                            <td>
                              <a class="btn btn-danger mr-2" href="<?=base_url("talep/ucguncikar/$talep->talep_yonlendirme_id")?>">-3 Gün</a>
                              <a class="btn btn-success" href="<?=base_url("talep/ucgunekle/$talep->talep_yonlendirme_id")?>">+3 Gün</a>
                            </td>
                            <td>
                              <i class="fa fa-user" style="font-size:13px"></i> <?=$talep->yonlenen_ad_soyad?>
                              <span style="color:<?=$color?>"><?=$message?></span>
                            </td>
                            <td>
                              <i class="fa fa-arrow-circle-right" style="font-size:13px"></i> <?=$talep->yonlendiren_ad_soyad?>
                            </td>
                            <td>
                              <i class="far fa-calendar-plus" style="margin-right:5px;opacity:1"></i> <?=$talep->talep_sonuc_adi?>
                              <br><span><?=$talep->gorusme_detay?></span>
                            </td>
                            <td>
                              <i class="far fa-calendar-plus" style="margin-right:5px;opacity:1"></i> <?=date('d.m.Y H:i',strtotime($talep->yonlendirme_tarihi));?>
                              <?php
