...
<a class="btn mobile-nav-btn btn-logout d-block"    onclick="return confirm('Bu talebi silmek istediğinizden emin misiniz?');" style="border: 1px solid #3a3a7f;border-left: 0px;border-top: 0;flex:0.5;background:rgb(166, 8, 8)" href="https://ugbusiness.com.tr/ugajans/gorev_sil/<?=$gorev->gorev_id?>">
