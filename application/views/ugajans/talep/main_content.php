...
<form action="<?=base_url("ugajans/talep_durum_guncelle/$talep->ugajans_talep_id")?>" method="post">
 ...
 <a class="btn mobile-nav-btn btn-logout d-block " style="background: #24243c; border: 1px solid #0060c7;border-left: 0px;border-top: 0;flex:1; " href="https://ugbusiness.com.tr/ugajans/talep?talep_filter=1">
 <span style="opacity:0.8!important;"><b> <i class="fas fa-user text-warning"></i> Ad Soyad : </b> <?=$talep->ugajans_talep_ad_soyad?> </span>
</a>
<a class="btn mobile-nav-btn btn-logout d-block " style="background: #24243c; border: 1px solid #0060c7;border-left: 0px;border-top: 0;flex:1;  " href="https://ugbusiness.com.tr/ugajans/talep?talep_filter=2">
...
<a class="btn mobile-nav-btn btn-logout d-block " style="background: #24243c; border: 1px solid #0060c7;border-left: 0px;border-top: 0;flex:1; " href="https://ugbusiness.com.tr/ugajans/talep?talep_filter=3">
<span style="opacity:0.8!important;"><b> <i class="fas fa-envelope text-warning"></i> Email : </b> <?=$talep->ugajans_talep_email_adres?> </span>
</a>
<a class="btn mobile-nav-btn btn-logout d-block" style="background: #24243c; border: 1px solid #0060c7;border-left: 0px;border-top: 0;flex:1; " href="https://ugbusiness.com.tr/ugajans/talep?talep_filter=4">
