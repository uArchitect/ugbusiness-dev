...
<form action="<?=base_url("ugajans/talep_durum_guncelle/$talep->ugajans_talep_id")?>" method="post">
  ...
  <div class="row" style="margin-top:-30px;margin-bottom:-30px">
    <div class="col-md-3">
    <a class="btn mobile-nav-btn btn-logout d-block p-3" style="background: #24243c; border: 1px solid #003671;flex:1; " href="https://ugbusiness.com.tr/ugajans/talep?talep_filter=1">
...
<a class="btn mobile-nav-btn btn-logout d-block p-3 " style="background: #24243c; border: 1px solid #003671;flex:1;  " href="https://ugbusiness.com.tr/ugajans/talep?talep_filter=2">
...
<a class="btn mobile-nav-btn btn-logout d-block p-3 " style="background: #24243c; border: 1px solid #003671;flex:1; " href="https://ugbusiness.com.tr/ugajans/talep?talep_filter=3">
...
<a class="btn mobile-nav-btn btn-logout d-block p-3" style="background: #24243c; border: 1px solid #003671;flex:1; " href="https://ugbusiness.com.tr/ugajans/talep?talep_filter=4">
