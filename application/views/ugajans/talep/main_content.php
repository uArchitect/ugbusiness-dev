...
<form action="<?=base_url("ugajans/talep_durum_guncelle/$talep->ugajans_talep_id")?>" method="post">
 ...
 <a class="btn mobile-nav-btn btn-logout d-block " style="background: #24243c; border: 1px solid #0060c7;border-left: 0px;flex:1; " href="https://ugbusiness.com.tr/ugajans/talep?talep_filter=1">
