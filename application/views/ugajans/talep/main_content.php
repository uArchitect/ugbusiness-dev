...
<form action="<?=base_url("ugajans/talep_durum_guncelle/$talep->ugajans_talep_id")?>" method="post">
  ...
  <div class="d-flex" style="margin-bottom: -8px!important;margin-top: -18px!important;border-left: 1px solid #003671;">
 <a class="btn mobile-nav-btn btn-logout d-block " style="background: #24243c; border: 1px solid #003671;border-left: 2px;flex:1; " href="https://ugbusiness.com.tr/ugajans/talep?talep_filter=1">
 <span style="opacity:0.8!important;"><b> <i class="fas fa-user text-warning"></i> Ad Soyad : </b> <?=$talep->ugajans_talep_ad_soyad?> </span>
</a>
<a class="btn mobile-nav-btn btn-logout d-block " style="background: #24243c; border: 1px solid #003671;border-left: 0px;flex:1;  " href="https://ugbusiness.com.tr/ugajans/talep?talep_filter=2">
...
<a class="btn mobile-nav-btn btn-logout d-block " style="background: #24243c; border: 1px solid #003671;border-left: 0px;flex:1; " href="https://ugbusiness.com.tr/ugajans/talep?talep_filter=3">
<span style="opacity:0.8!important;"><b> <i class="fas fa-envelope text-warning"></i> Email : </b> <?=$talep->ugajans_talep_email_adres?> </span>
</a>
<a class="btn mobile-nav-btn btn-logout d-block" style="background: #24243c; border: 1px solid #003671;border-left: 0px;flex:1; " href="https://ugbusiness.com.tr/ugajans/talep?talep_filter=4">
