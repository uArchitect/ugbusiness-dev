...
<form action="<?=base_url("ugajans/talep_durum_guncelle/$talep->ugajans_talep_id")?>" method="post">
  ...
  <div class="row" style="margin-top:-30px;margin-bottom:-30px">
    <div class="col-md-3">
    <a class="btn mobile-nav-btn btn-logout d-block p-3" style="    height: 100%;background: #24243c; border: 1px solid #003671;flex:1; " href="https://ugbusiness.com.tr/ugajans/talep?talep_filter=1">
...
<a class="btn mobile-nav-btn btn-logout d-block p-3 " style="    height: 100%;background: #24243c; border: 1px solid #003671;flex:1;  " href="https://ugbusiness.com.tr/ugajans/talep?talep_filter=2">
...
<a class="btn mobile-nav-btn btn-logout d-block p-3 " style="    height: 100%;background: #24243c; border: 1px solid #003671;flex:1; " href="https://ugbusiness.com.tr/ugajans/talep?talep_filter=3">
...
<a class="btn mobile-nav-btn btn-logout d-block p-3" style="    height: 100%;background: #24243c; border: 1px solid #003671;flex:1; " href="https://ugbusiness.com.tr/ugajans/talep?talep_filter=4">
<span style="opacity:0.8!important;"><b> <i class="fas fa-info-circle text-warning" style="display: block; margin-bottom: 7px;"></i> Detay : </b> <?=$talep->ugajans_talep_detay?> </span>
  ...
  <br>  <br>
  <span style="opacity:0.8!important;margin-left:6px;"><span style="    color: #07ed07;"> <i class="fa fa-check"></i> Talep Sonlandırma Notu</span> </span>
  <br>
  <textarea name="ugajans_talep_sonlandirma_notu" class="form-control" placeholder="Bu bölüme talep ile ilgili sonlandırma veya görüşme notunuzu girebilirsiniz.." id="" style="
    background: #24243c; border: 1px solid #003671; color:white;
   margin-left:6px;
    margin-top: 5px;
"><?=$talep->ugajans_talep_sonlandirma_notu?></textarea> 
<br>
<span style="opacity:0.8!important;margin-left:6px;"><span style="color: #fefffe;"> <i class="fa fa-question-circle"></i> Talep Durumu</span> </span>
  <br>
