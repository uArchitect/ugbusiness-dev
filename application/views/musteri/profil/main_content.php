...
">   <span style="min-width: 230px; width: 230px; display: inline-block; margin-left:10px"> <b style="color:black"><?=$urun->urun_adi?></b> /  <?=$urun->seri_numarasi != "" ? '<span style="color:black">'.$urun->seri_numarasi."</span>" : "<span class='text-danger'>Seri No Atanmadı</span>"?> </span> 
