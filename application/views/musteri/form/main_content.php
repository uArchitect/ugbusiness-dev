...
<div class="row" style="background: whitesmoke;border: 2px dashed #495057ab; margin:1px;margin-bottom:10px !important">
    ...
    <!-- /.row -->
      ...
      <div class="form-group col pl-0">
        ...
        <input type="text" value="<?php echo  !empty($musteri) ? $musteri->musteri_ad : (!empty($talep) ? $talep[0]->talep_musteri_ad_soyad : "");?>" class="form-control" name="musteri_ad" required="" placeholder="Müşteri Adını Giriniz..."   autofocus="">
       </div>
...
if(empty($musteri)){
 ...
 <div style="background:whitesmoke;border: 2px dashed #b5b5b5;" class="p-2">
        ...
        <input type="text" required value="<?=(!empty($talep) ? $talep[0]->talep_isletme_adi : (!empty($eski_data) ? $eski_data[0]->SalonAdi : ""))?>" class="form-control" name="merkez_adi" maxlength="50" placeholder="İşyeri / Merkez Adı Giriniz..."  >
      </div>
