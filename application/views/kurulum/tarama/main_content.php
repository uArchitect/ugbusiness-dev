    ...
    if (kod) {
      ...
      if (bulundu) {
        ...
        if (video.style.display !== "none") {
          photoButton.style.display = "inline-block";  // Butonu sadece QR kodu bulunduğunda göster
        }
      } else {
        setDurum("BELGE TANINMADI", "red");
        video.classList.remove("green");
        video.classList.add("red");
        photoButton.style.display = "none";  // QR kodu tanınmadığında butonu gizle
      }
    } else {
      photoButton.style.display = "none";  // QR kodu kaybolursa butonu gizle
    }
  }
