...
<?php if(!empty($guncellenecek_islem)): ?>
 ...
 <div class="form-group">
                ...
                <label for="formClient-Name" style="font-weight:normal;  opacity:0.5; ">(*İsteğe Bağlı)</label>
                <input type="text" class="form-control mb-2" name="servis_islem_ucreti" value="<?=$guncellenecek_islem->servis_islem_ucreti?>" placeholder="İşlem ücretini giriniz..."></textarea>
...
<div class="row">
              <div class="col">
                <h3 class="card-title text-center" style="font-size: 15px; margin-top: 4px;">
...
<div class="card card-dark  mt-2 <?=(empty($filter) ? "d-none":"")?>" style="margin-top: 0px !important;    margin-bottom: 2px; ">
  ...
  <h3 class="card-title text-center" >
    SERVİS BİLGİLERİNİ DÜZENLE DÜZENLE  
  </h3>
  </div>
  <div class="card-body">
