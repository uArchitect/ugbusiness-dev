...
<div class="content-wrapper p-1 mobil-genislik d-none d-sm-block" style="padding-top:0px;margin-top:-4px; margin-right: -4px;">
  <div style="background: #3d3a3a;height: 40px;width: 100%;color: #ffffff;border-top: 1px solid #1b1c21;text-align: right;padding-top: 9px;border-bottom: 2px solid #181818;" class="<?=($yemek->yemek_detay=="")?"d-none":""?>">
  <b>YEMEK MENÜ : </b>
  <?php
    $items = explode('#', $yemek->yemek_detay);
    $lastItem = end($items);   
...
<div tabindex="-1" class=" d-none d-sm-block" style="position: relative; width: 100%;  height: 1051px; padding-top: 50.0000%;padding-bottom: 0; box-shadow: 0 2px 8px 0 rgba(63,69,81,0.16);  margin-bottom: 0.9em; overflow: hidden;border-radius: 8px; will-change: transform;">
