    ...
    <div class="card card-success" style="border-radius:0px !important;">
              ...
              <table id="examplekullanicilar2" class="table table-bordered table-striped"    >
                  ...
                  <tbody>
                    ...
                    <td>
                        <a href="<?=base_url("kullanici_sablon_tanim/cikar_tanim/$kullanici->kullanici_sablon_tanim_id/$veri->sablon_veri_id")?>" class="btn btn-sm btn-danger"><i class="fa fa-trash"></i> Çıkar</a>
                        </td>
