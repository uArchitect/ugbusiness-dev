...
<div class="card card-dark" style="border-radius:0px !important;">
              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    <?php $count=0; foreach ($departmanlar as $departman) : ?>
                      <?php $count++?>
                    <tr>
                      <td><?=$count?></td> 
                      ...
                      <td style="display: flex;">
                        ...
                        <?=($departman->departman_aciklama) ? $departman->departman_aciklama : "<span style='opacity:0.4'>Açıklama Girilmedi</span>"?>
 
                      </td>
                      <td><i class="far fa-calendar-plus" style="margin-right:5px;opacity:1"></i> <?=date('d.m.Y H:i',strtotime($departman->departman_kayit_tarihi));?></td>
                      <td>
                        <?php
                          if($departman->departman_guncelleme_tarihi > $departman->departman_kayit_tarihi){
                            ?>
                              <i class="fa fa-sync" style="margin-right:5px;opacity:1"></i> <?=date('d.m.Y H:i',strtotime($departman->departman_guncelleme_tarihi));?>
                            <?php
                          }else{
                            ?>
