  ...
  <div class="row">
     ...
     <div class="card card-dark card-outline">
              ...
              <div class="text-center">
                  <img class="profile-user-img img-fluid img-circle" src="<?=$urun_detay->urun_png_gorsel?>" style="border: 0px;width: 300px;margin-bottom: -166px;" alt="User profile picture">
                </div>
 <div style="
    background: #ffffff;
    z-index: 9999;
