            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="<?php echo base_url('dashboard'); ?>">Anasayfa</a></li>
                        <li class="breadcrumb-item active">Senet Listesi</li>
                    </ol>
                </div>
            </div>
        </div>
                                    ...
                                    <?php if (!empty($senetler)): ?>
                                        <?php foreach ($senetler as $senet): ?>
                                            ...
                                            <tr class="<?php echo $durum->satir_class; ?>">
                                                ...
                                                <td>
                                                    <?php echo $durum->kalan_gun_metni; ?>
                                                </td>
                                                <td class="text-right">
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    deleteButtons.forEach(button => {
        button.addEventListener('click', function (e) {
            ...
            Swal.fire({
                title: 'Emin misiniz?',
                text: "Bu senedi silmek istediğinizden emin misiniz? Bu işlem geri alınamaz!",
                icon: 'warning',
