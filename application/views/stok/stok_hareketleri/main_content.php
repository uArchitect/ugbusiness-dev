...
<div class="card card-dark" style="border-radius:0px !important;">
              ...
              <h3 class="card-title"><strong>UG Business</strong> - Stok Hareketleri</h3>
        ...
        <thead>
            <tr>
                <th style="max-width:70px;width:70px;">Hareket ID</th>
                <th>Stok Adı</th>
                <th>Giriş Miktar</th> 
                <th>Çıkış Miktar</th>
                <th>Kullanıcı</th>
                <th style="width:120px">Hareket Tarihi</th>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            $('#users_table').DataTable({
                ...
                scrollX: true,
                "ajax": {
                    "url": "<?php echo site_url('stok/get_stok_hareketleri_ajax'); ?>",
                    "type": "GET"
                },
                "language": {
