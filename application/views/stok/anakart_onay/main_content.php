  ...
  <div class="row">
    <section class="content col-lg-5">
      <div class="card card-dark p-0">
        <div class="card-header with-border">
          <h3 class="card-title"> <i class="ion ion-person-stalker"></i> ANAKART ONAYLA</h3>
        </div>


            <form class="form-horizontal" onsubmit="submitFormWaiting()" method="POST" action="<?php echo site_url('stok/anakart_kontrol');?>">
    ...
    <div class="card-body" style="background:#ffffff;">
     ...
     <div class="form-group">
        <label for="formClient-Name">Anakart QR Seri Numarası</label>
