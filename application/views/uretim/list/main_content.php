...
<div class="col">
 ...
 <div class="row" >
                       ...
                       <span style="display: block;background:<?=str_contains(strtolower($d->kayit_notu), 'yenilenmiş') ? "#cfffc8" : "#dddddd"?>; text-align: center; padding: 5px;color: white;border-radius: 5px;border-radius: 3px 3px 0 0;">
