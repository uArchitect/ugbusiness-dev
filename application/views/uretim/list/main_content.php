...
<div class="col">
 ...
 <div class="row" >
                       ...
                       <span style="display: block;background:<?=(strpos($d->kayit_notu, 'yen') === false && strpos($d->kayit_notu, 'Yen') === false  || strpos($d->kayit_notu, 'YEN') === false ) ? "#cfffc8" : "#dddddd"?>; text-align: center; padding: 5px;color: white;border-radius: 5px;border-radius: 3px 3px 0 0;">
