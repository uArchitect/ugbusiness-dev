...
<div class="row">
  ...
  <a href="<?=base_url("kullanici/profil_kullanici_satis_rapor/$secilen_kullanici/$secilen_ay/2023")?>" style="border-radius: 54px;width:250px;font-size: 27px !important; font-weight: 700;" class="btn btn-<?=$secilen_yil == 2023 ? "success" : "default"?> mr-2">2023</a>
...
<div class="row p-2 pl-2 pr-2" style="margin-top:-30px;    flex-wrap: nowrap;">
    <div class="col" style="padding:2px"><a href="<?=base_url("kullanici/profil_kullanici_satis_rapor/$secilen_kullanici/1/$secilen_yil")?>" class="btn btn-default" style="<?=$secilen_ay == 1  ? "border:1px solid red;background-color:red;color:white;font-weight:bold;" : "background-color:#ffffff!important;"?>border-radius:90px!important;width: -webkit-fill-available;">OCAK</a></div>
    <div class="col" style="padding:2px"><a href="<?=base_url("kullanici/profil_kullanici_satis_rapor/$secilen_kullanici/2/$secilen_yil")?>" class="btn btn-default" style="<?=$secilen_ay == 2  ? "border:1px solid red;background-color:red;color:white;font-weight:bold;" : "background-color:#ffffff!important;"?>border-radius:90px!important;width: -webkit-fill-available;">ŞUBAT</a></div>
    <div class="col" style="padding:2px"><a href="<?=base_url("kullanici/profil_kullanici_satis_rapor/$secilen_kullanici/3/$secilen_yil")?>" class="btn btn-default" style="<?=$secilen_ay == 3  ? "border:1px solid red;background-color:red;color:white;font-weight:bold;" : "background-color:#ffffff!important;"?>border-radius:90px!important;width: -webkit-fill-available;">MART</a></div>
    <div class="col" style="padding:2px"><a href="<?=base_url("kullanici/profil_kullanici_satis_rapor/$secilen_kullanici/4/$secilen_yil")?>" class="btn btn-default" style="<?=$secilen_ay == 4  ? "border:1px solid red;background-color:red;color:white;font-weight:bold;" : "background-color:#ffffff!important;"?>border-radius:90px!important;width: -webkit-fill-available;">NİSAN</a></div>
    <div class="col" style="padding:2px"><a href="<?=base_url("kullanici/profil_kullanici_satis_rapor/$secilen_kullanici/5/$secilen_yil")?>" class="btn btn-default" style="<?=$secilen_ay == 5  ? "border:1px solid red;background-color:red;color:white;font-weight:bold;" : "background-color:#ffffff!important;"?>border-radius:90px!important;width: -webkit-fill-available;">MAYIS</a></div>
    <div class="col" style="padding:2px"><a href="<?=base_url("kullanici/profil_kullanici_satis_rapor/$secilen_kullanici/6/$secilen_yil")?>" class="btn btn-default" style="<?=$secilen_ay == 6  ? "border:1px solid red;background-color:red;color:white;font-weight:bold;" : "background-color:#ffffff!important;"?>border-radius:90px!important;width: -webkit-fill-available;">HAZİRAN</a></div>
    <div class="col" style="padding:2px"><a href="<?=base_url("kullanici/profil_kullanici_satis_rapor/$secilen_kullanici/7/$secilen_yil")?>" class="btn btn-default" style="<?=$secilen_ay == 7  ? "border:1px solid red;background-color:red;color:white;font-weight:bold;" : "background-color:#ffffff!important;"?>border-radius:90px!important;width: -webkit-fill-available;">TEMMUZ</a></div>
    <div class="col" style="padding:2px"><a href="<?=base_url("kullanici/profil_kullanici_satis_rapor/$secilen_kullanici/8/$secilen_yil")?>" class="btn btn-default" style="<?=$secilen_ay == 8  ? "border:1px solid red;background-color:red;color:white;font-weight:bold;" : "background-color:#ffffff!important;"?>border-radius:90px!important;width: -webkit-fill-available;">AĞUSTOS</a></div>
    <div class="col" style="padding:2px"><a href="<?=base_url("kullanici/profil_kullanici_satis_rapor/$secilen_kullanici/9/$secilen_yil")?>" class="btn btn-default" style="<?=$secilen_ay == 9  ? "border:1px solid red;background-color:red;color:white;font-weight:bold;" : "background-color:#ffffff!important;"?>border-radius:90px!important;width: -webkit-fill-available;">EYLÜL</a></div>
    <div class="col" style="padding:2px"><a href="<?=base_url("kullanici/profil_kullanici_satis_rapor/$secilen_kullanici/10/$secilen_yil")?>" class="btn btn-default" style="<?=$secilen_ay == 10 ? "border:1px solid red;background-color:red;color:white;font-weight:bold;" : "background-color:#ffffff!important;"?>border-radius:90px!important;width: -webkit-fill-available;">EKİM</a></div>
    <div class="col" style="padding:2px"><a href="<?=base_url("kullanici/profil_kullanici_satis_rapor/$secilen_kullanici/11/$secilen_yil")?>" class="btn btn-default" style="<?=$secilen_ay == 11 ? "border:1px solid red;background-color:red;color:white;font-weight:bold;" : "background-color:#ffffff!important;"?>border-radius:90px!important;width: -webkit-fill-available;">KASIM</a></div>
    <div class="col" style="padding:2px"><a href="<?=base_url("kullanici/profil_kullanici_satis_rapor/$secilen_kullanici/12/$secilen_yil")?>" class="btn btn-default" style="<?=$secilen_ay == 12 ? "border:1px solid red;background-color:red;color:white;font-weight:bold;" : "background-color:#ffffff!important;"?>border-radius:90px!important;width: -webkit-fill-available;">ARALIK</a></div>
</div>
                  ...
                  <tbody style="width: 100% !important;">
                   ...
                   <?php foreach ($satislar as $satis){?>
                    ...
                    <?php 
                         ...
                         ?>
                          <a href="<?= $urlcustom?>"  >(<?=$satis->siparis_kodu?>)</a>
