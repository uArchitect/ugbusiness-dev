...
function createPersonnelCard(array $data, int $departmanId, string $baslik, string $colClass, int $desktopColumns = 3): void
{
    ...
    foreach ($filteredPersonnel as $personel) {
        ...
        echo '        < href="https://ugbusiness.com.tr/kullanici/profil_new/' . $personel["mesai_takip_kullanici_id"] . '?subpage=mesai-bilgileri" target="_blank" type="button" class="btn btn-secondary custombtn me-1 m-1 mb-1"';
