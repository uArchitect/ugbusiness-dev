...
<a href="https://ugbusiness.com.tr/kullanici/tum_limitleri_kapat/<?=(!empty($_GET["k"]) ? $_GET["k"] : "0")?>" type="button" class="btn btn-danger btn-sm" style="float: right!important;padding: 0px;padding-left: 5px;padding-right: 5px;    padding-top: 7px;"><i class="fa fa-plus" style="font-size:12px" aria-hidden="true"></i> 
Tümünü Kapat</a>

<a href="https://ugbusiness.com.tr/kullanici/tum_limitleri_ac/<?=(!empty($_GET["k"]) ? $_GET["k"] : "0")?>" type="button" class="btn btn-success btn-sm" style="float: right!important;padding: 0px;padding-left: 5px;padding-right: 5px;    padding-top: 7px;"><i class="fa fa-plus" style="font-size:12px" aria-hidden="true"></i> 
Tümünü Aç</a>
              ...
              <div class="card-body" style="background:white;">
                ...
                <table id="example1limitler" class="table table-bordered table-striped nowrap">
                  ...
                  <tr>
                    ...
                    <th>Vadeli Robotx<br>Takas Fiyatı</th>
                    <th>Nakit Diğer C.<br>Takas Fiyatı</th>
                    <th>Vadeli Diğer C.<br>Takas Fiyatı</th>
  ...
  <span class="slider round"></span>
                      ...
                      <td style="text-align: center;padding: 0px !important;    padding-right: 6px !important;">
                          <a target="_blank" type="button" data-id="<?=$limit->satis_fiyat_limit_id?>" style="width: 100%;
    height: 70px;
    margin-right: 3px;
    margin-left: 3px;
   ...
   editButtons.forEach(button => {
      button.addEventListener('click', function (e) {
        ...
        var top = (screen.height / 2) - (600 / 2 + 50);
         ...
         const editWindow = window.open('<?=base_url("kullanici/fiyat_guncelle_view/")?>' + limitId, 'Edit Price', 'width=890,height=600,'+',top=' + top + ',left=' + left);
