...
?>
    <span ><?=$kullanici->musteri_iletisim_numarasi?> <?=$cvc->success ? "(Reklam) (".(date("d.m.Y",strtotime($cvc->date))).")"."(".($interval->days < 181 ? " Gün)" : "" ).talep_kaynak_k($kullanici->musteri_iletisim_numarasi):""?>
