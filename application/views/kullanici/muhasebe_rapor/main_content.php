                   ...
                   <?php foreach ($kullanicilar as $kullanici){?>
                    ...
                    <td>
                      ...
                      <td>
                        ...
                        ?>
                        <a style="cursor:pointer;color:block;text-decoration:underline;"  onclick="showWindow('<?= $pkurl?>');">  <?=mb_strtoupper($kullanici->kullanici_ad_soyad)?>  </a>
                      </td>
                      <td>
                        ...
                        ?>
                        <a style="cursor:pointer; "  onclick="showWindow('<?= $purl?>');"><?=$kullanici->musteri_ad?> </a>
                      </td>
