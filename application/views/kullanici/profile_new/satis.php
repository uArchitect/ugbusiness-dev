...
<div class="header" style="margin: 13px;">
            ...
            <div class="btn-group mb-2" style="padding: 0px;">
                  <a href="<?=base_url("kullanici/profil_new/".$data_kullanici->kullanici_id."?subpage=satis&selected_month=0&selected_year=".$_GET["selected_year"])?>"   style="<?=($current_month == 0 ? "background : #7d0000;color:white;" : "background:black;color:white;")?> border-radius: 0px; margin-left: -1px;" onclick="//filterwrite(this,'');" class="btn btn-default">Tümünü Görüntüle</a> 
                  <a href="<?=base_url("kullanici/profil_new/".$data_kullanici->kullanici_id."?subpage=satis&selected_month=1&selected_year=".$_GET["selected_year"])?>"   style="<?=($current_month == 1 ? "background : #7d0000;color:white;" : "background:black;color:white;")?> " class="btn btn-default">Ocak <?=$_GET["selected_year"]?></a>
                  <a href="<?=base_url("kullanici/profil_new/".$data_kullanici->kullanici_id."?subpage=satis&selected_month=2&selected_year=".$_GET["selected_year"])?>"   style="<?=($current_month == 2 ? "background : #7d0000;color:white;" : "background:black;color:white;")?> " class="btn btn-default">Şubat <?=$_GET["selected_year"]?></a>
                  <a href="<?=base_url("kullanici/profil_new/".$data_kullanici->kullanici_id."?subpage=satis&selected_month=3&selected_year=".$_GET["selected_year"])?>"   style="<?=($current_month == 3 ? "background : #7d0000;color:white;" : "background:black;color:white;")?> " class="btn btn-default">Mart <?=$_GET["selected_year"]?></a>
                  <a href="<?=base_url("kullanici/profil_new/".$data_kullanici->kullanici_id."?subpage=satis&selected_month=4&selected_year=".$_GET["selected_year"])?>"   style="<?=($current_month == 4 ? "background : #7d0000;color:white;" : "background:black;color:white;")?> " class="btn btn-default">Nisan <?=$_GET["selected_year"]?></a>
                  <a href="<?=base_url("kullanici/profil_new/".$data_kullanici->kullanici_id."?subpage=satis&selected_month=5&selected_year=".$_GET["selected_year"])?>"   style="<?=($current_month == 5 ? "background : #7d0000;color:white;" : "background:black;color:white;")?> " class="btn btn-default">Mayıs <?=$_GET["selected_year"]?></a>
                  <a href="<?=base_url("kullanici/profil_new/".$data_kullanici->kullanici_id."?subpage=satis&selected_month=6&selected_year=".$_GET["selected_year"])?>"   style="<?=($current_month == 6 ? "background : #7d0000;color:white;" : "background:black;color:white;")?> " class="btn btn-default">Haziran <?=$_GET["selected_year"]?></a>
                  <a href="<?=base_url("kullanici/profil_new/".$data_kullanici->kullanici_id."?subpage=satis&selected_month=7&selected_year=".$_GET["selected_year"])?>"   style="<?=($current_month == 7 ? "background : #7d0000;color:white;" : "background:black;color:white;")?> " class="btn btn-default">Temmuz <?=$_GET["selected_year"]?></a>
                  <a href="<?=base_url("kullanici/profil_new/".$data_kullanici->kullanici_id."?subpage=satis&selected_month=8&selected_year=".$_GET["selected_year"])?>"   style="<?=($current_month == 8 ? "background : #7d0000;color:white;" : "background:black;color:white;")?> " class="btn btn-default">Ağustos <?=$_GET["selected_year"]?></a>
                  <a href="<?=base_url("kullanici/profil_new/".$data_kullanici->kullanici_id."?subpage=satis&selected_month=9&selected_year=".$_GET["selected_year"])?>"   style="<?=($current_month == 9 ? "background : #7d0000;color:white;" : "background:black;color:white;")?> " class="btn btn-default">Eylül <?=$_GET["selected_year"]?></a>
                  <a href="<?=base_url("kullanici/profil_new/".$data_kullanici->kullanici_id."?subpage=satis&selected_month=10&selected_year=".$_GET["selected_year"])?>"  style="<?=($current_month == 10 ? "background : #7d0000;color:white;" : "background:black;color:white;")?> " class="btn btn-default">Ekim <?=$_GET["selected_year"]?></a>
                  <a href="<?=base_url("kullanici/profil_new/".$data_kullanici->kullanici_id."?subpage=satis&selected_month=11&selected_year=".$_GET["selected_year"])?>"  style="<?=($current_month == 11 ? "background : #7d0000;color:white;" : "background:black;color:white;")?> " class="btn btn-default">Kasım <?=$_GET["selected_year"]?></a>
                  <a href="<?=base_url("kullanici/profil_new/".$data_kullanici->kullanici_id."?subpage=satis&selected_month=12&selected_year=".$_GET["selected_year"])?>"  style="<?=($current_month == 12 ? "background : #7d0000;color:white;" : "background:black;color:white;")?> border-radius: 0px; margin-right: -1px;" class="btn btn-default">Aralık <?=$_GET["selected_year"]?></a>
                </div>
