...
<div class="header" style="margin: 13px;">
            ...
            <div class="btn-group mb-2" style="padding: 0px;">
                  ...
                  <a href="<?=base_url("kullanici/muhasebe_rapor/3/".$_GET["selected_year"])?>"   style="<?=($current_month == 3 ? "background : #7d0000;color:white;" : "background:black;color:white;")?> " class="btn btn-default">Mart <?=$_GET["selected_year"]?></a>
                  <a href="<?=base_url("kullanici/muhasebe_rapor/4/".$_GET["selected_year"])?>"   style="<?=($current_month == 4 ? "background : #7d0000;color:white;" : "background:black;color:white;")?> " class="btn btn-default">Nisan <?=$_GET["selected_year"]?></a>
                  <a href="<?=base_url("kullanici/muhasebe_rapor/5/".$_GET["selected_year"])?>"   style="<?=($current_month == 5 ? "background : #7d0000;color:white;" : "background:black;color:white;")?> " class="btn btn-default">Mayıs <?=$_GET["selected_year"]?></a>
                  <a href="<?=base_url("kullanici/muhasebe_rapor/6/".$_GET["selected_year"])?>"   style="<?=($current_month == 6 ? "background : #7d0000;color:white;" : "background:black;color:white;")?> " class="btn btn-default">Haziran <?=$_GET["selected_year"]?></a>
                  <a href="<?=base_url("kullanici/muhasebe_rapor/7/".$_GET["selected_year"])?>"   style="<?=($current_month == 7 ? "background : #7d0000;color:white;" : "background:black;color:white;")?> " class="btn btn-default">Temmuz <?=$_GET["selected_year"]?></a>
                  <a href="<?=base_url("kullanici/muhasebe_rapor/8/".$_GET["selected_year"])?>"   style="<?=($current_month == 8 ? "background : #7d0000;color:white;" : "background:black;color:white;")?> " class="btn btn-default">Ağustos <?=$_GET["selected_year"]?></a>
                  <a href="<?=base_url("kullanici/muhasebe_rapor/9/".$_GET["selected_year"])?>"   style="<?=($current_month == 9 ? "background : #7d0000;color:white;" : "background:black;color:white;")?> " class="btn btn-default">Eylül <?=$_GET["selected_year"]?></a>
                  <a href="<?=base_url("kullanici/muhasebe_rapor/10/".$_GET["selected_year"])?>"  style="<?=($current_month == 10 ? "background : #7d0000;color:white;" : "background:black;color:white;")?> " class="btn btn-default">Ekim <?=$_GET["selected_year"]?></a>
                  <a href="<?=base_url("kullanici/muhasebe_rapor/11/".$_GET["selected_year"])?>"  style="<?=($current_month == 11 ? "background : #7d0000;color:white;" : "background:black;color:white;")?> " class="btn btn-default">Kasım <?=$_GET["selected_year"]?></a>
                  <a href="<?=base_url("kullanici/muhasebe_rapor/12/".$_GET["selected_year"])?>"  style="<?=($current_month == 12 ? "background : #7d0000;color:white;" : "background:black;color:white;")?> border-radius: 0px; margin-right: -1px;" class="btn btn-default">Aralık <?=$_GET["selected_year"]?></a>
                </div>
