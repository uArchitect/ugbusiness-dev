...
<div class="header" style="margin: 13px;">
            ...
            <div class="btn-group" style="float: right; margin-top: -49px; margin-right: 10px;">
              <a href="<?=base_url('kullanici/profil_new/'.$data_kullanici->kullanici_id.'?subpage=satis&selected_month=0&selected_year=2023')?>" class="btn <?=$_GET["selected_year"] == "2023" ? "btn-success" : "btn-default" ?>">2023</a>
              <a href="<?=base_url('kullanici/profil_new/'.$data_kullanici->kullanici_id.'?subpage=satis&selected_month=0&selected_year=2024')?>" class="btn <?=$_GET["selected_year"] == "2024" ? "btn-success" : "btn-default" ?>">2024</a>
                  ...
                  <tbody style="width: 100% !important;">
                   ...
                   <?php foreach ($satislar as $kullanici){?>
                    ...
                    <td>
                         ...
                         ?>
                          <a href="<?=$urlcustom?>" target="_blank"><?=$kullanici->siparis_kodu?></a>
                      </td>
