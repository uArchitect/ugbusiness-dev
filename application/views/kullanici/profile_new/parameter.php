...
<section  id="kisisel-bilgiler"  class="resume-personal-info">
            ...
            <tr>
                ...
                <tr>
                    <th style="<?=$data_kullanici->arac_menu_gorunum == 0 ? "    border: 1px solid red;background:#fcc5c5d9" : "background:#cdfeb6"?>">Araç Menü Görünüm</th>
                    <td>
                ...
                <tr>
                    <th style="<?=$data_kullanici->satis_menu_gorunum == 0 ? "    border: 1px solid red;background:#fcc5c5d9" : "background:#cdfeb6"?>">Satış Menü Görünüm</th>
                    <td>
                ...
                <tr>
                    <th style="<?=$data_kullanici->egitim_menu_gorunum == 0 ? "    border: 1px solid red;background:#fcc5c5d9" : "background:#cdfeb6"?>">Eğitim Menü Görünüm</th>
                    <td>
                ...
                <tr>
                    <th style="<?=$data_kullanici->talep_menu_gorunum == 0 ? "    border: 1px solid red;background:#fcc5c5d9" : "background:#cdfeb6"?>">Talep Menü Görünüm</th>
                    <td>
                ...
                <tr>
                    <th style="<?=$data_kullanici->mesai_menu_gorunum == 0 ? "    border: 1px solid red;background:#fcc5c5d9" : "background:#cdfeb6"?>">Mesai Menü Görünüm</th>
                    <td>
                    ...
                    <th style="<?=$data_kullanici->envanter_menu_gorunum == 0 ? "    border: 1px solid red;background:#fcc5c5d9" : "background:#cdfeb6"?>">Envanter Menü Görünüm</th>
                    <td>
                ...
                <tr>
                    <th style="<?=$data_kullanici->iletisim_menu_gorunum == 0 ? "    border: 1px solid red;background:#fcc5c5d9" : "background:#cdfeb6"?>">İletişim Menü Görünüm</th>
                    <td>
