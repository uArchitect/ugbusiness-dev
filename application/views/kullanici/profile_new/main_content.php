            ...
            <div class="card">
              <div class="card-header p-2">
                <ul class="nav nav-pills">
                  ...
                  Araç Bilgisi</a></li>
                  <li class="nav-item"><a class="nav-link btn-default" href="#timeline" data-toggle="tab">
                  <i class="nav-icon 	fas fa-people-arrows " style="font-size:13px"></i>  
                  Satış Rapor</a></li>
                  <li class="nav-item"><a class="nav-link btn-default" href="#settings" data-toggle="tab">
