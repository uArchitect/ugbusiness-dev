            ...
            <div class="card">
              <div class="card-header p-2"  >
                ...
                <li class="nav-item" style="flex: 1;"><a class="nav-link btn btn-default"  href="<?=base_url("kullanici/profil_new/$data_kullanici->kullanici_id?subpage=ozluk-dosyasi")?>"  >
                  ...
                  Araç Bilgisi</a></li>
                  <li class="nav-item" style="flex: 1;"><a class="nav-link btn btn-default" style="margin-left: 6px;" href="<?=base_url("kullanici/profil_new/$data_kullanici->kullanici_id?subpage=satis")?>" >
                  <i class="nav-icon 	fas fa-people-arrows " style="font-size:13px"></i>  
                  Satış Rapor</a></li>
                  <li class="nav-item" style="flex: 1;"><a class="nav-link btn btn-default" style="margin-left: 6px;" href="<?=base_url("kullanici/profil_new/$data_kullanici->kullanici_id?subpage=egitim")?>">
                  <i class="nav-icon 	fas fa-people-arrows " style="font-size:13px"></i>  
                  Eğitim Rapor</a></li>
                  ...
                  <li class="nav-item" style="flex: 1;"><a class="nav-link btn btn-default" style="margin-left: 6px;"  href="<?=base_url("kullanici/profil_new/$data_kullanici->kullanici_id?subpage=envanter")?>"  >
                  <i class="nav-icon 	fas fa-award " style="font-size:13px"></i>  
                  Envanter</a></li>
                  <li class="nav-item" style="flex: 1;"><a class="nav-link btn btn-default" style="margin-left: 6px;" href="<?=base_url("kullanici/profil_new/$data_kullanici->kullanici_id?subpage=iletisim")?>"  >
