...
<style>
  /* Responsive düzenlemeler - sadece mobil için */
      ...
      <div class="container-fluid" style="padding:0px!important;">
        <div class="row">
          <div class="col-md-3 p-0">
            ...
            <!-- Profile Image -->
            <div class="card card-dark card-outline" style="position: sticky; top: 0; height: 100vh; overflow-y: auto;">
...
<?php
              ...
              <div class="card-body" style="overflow-y: auto; flex: 1; padding: 0px!important;">
