...
<body style="font-family:arial;">
    ...
    <table border="1" style="border-color:black">
        ...
        <tr>
            ...
            <td style="padding:10px;padding-left:15px;"><?= $metin->metin_ingilizce != "" ? $metin->metin_ingilizce : "<span style='color:red;'># Not Defined</span>" ?></td>
            <td style="padding:10px;padding-left:15px;"><?= $metin->metin_almanca != "" ? $metin->metin_almanca : "<span style='color:red;'># Undefiniert</span>" ?></td>
            <td style="padding:10px;padding-left:15px;direction: rtl;"><?= $metin->metin_arapca != "" ? $metin->metin_arapca : "<span style='color:red;'># غير محدد</span>" ?></td>
            <td style="padding:10px;padding-left:15px;"><?= $metin->metin_rusca != "" ? $metin->metin_rusca : "<span style='color:red;'># Не определено</span>" ?></td>
