        ...
        <table class="table table-bordered table-hover">
            ...
            <tbody>
                ...
                <tr onclick="location.href='<?php echo site_url('abonelik/duzenle/'.$abonelik->abonelik_id); ?>';" class="<?php echo $row_class; ?>" style="text-align: center; font-size: 15px;">
                    ...
                    <td><?=(date() > date(strtotime($abonelik->abonelik_bitis_tarihi)) ) ? gunSayisiHesapla(date("d.m.Y"),date("d.m.Y",strtotime($abonelik->abonelik_bitis_tarihi)))." Gün Kaldı" : gunSayisiHesapla(date("d.m.Y"),date("d.m.Y",strtotime($abonelik->abonelik_bitis_tarihi))." Gün Geçti!")?> </td>
                    <td>
