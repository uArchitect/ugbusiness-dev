      ...
      <div class="col-12">
        <div class="card border-0 shadow-sm" style="border-radius: 12px; overflow: hidden;">
            ...
            <div class="d-flex align-items-center justify-content-between">
              <div class="d-flex align-items-center">
                <div class="rounded-circle d-flex align-items-center justify-content-center mr-3" style="width: 40px; height: 40px; background-color: rgba(255,255,255,0.2);">
                  <i class="fas fa-plus-circle" style="color: #ffffff; font-size: 18px;"></i>
                </div>
                <div>
                  <h3 class="mb-0" style="color: #ffffff; font-weight: 700; font-size: 20px; letter-spacing: 0.5px; line-height: 1.2;">
                    Yeni Abonelik Ekle
                  </h3>
                  <small style="color: rgba(255,255,255,0.9); font-size: 13px; line-height: 1.4;">Yeni abonelik kaydı oluşturun</small>
                </div>
              </div>
          ...
          <div class="card-body" style="padding: 30px; background-color: #ffffff;">
            <form action="<?php echo site_url('abonelik/ekle_islem'); ?>" method="post" onsubmit="return validateDates()" id="abonelikForm">
              ...
              <div class="form-group-modern mb-4">
                ...
                <textarea 
                  ...
                  class="form-control form-control-modern" 
                  rows="4"
                  placeholder="Abonelik açıklamasını giriniz (isteğe bağlı)"></textarea>
                <small class="form-text text-muted">
              ...
              <div class="alert alert-info alert-modern mb-4" role="alert">
                ...
                <strong>İpucu:</strong> Başlangıç tarihi bugünden önceki bir tarih olabilir, ancak bitiş tarihi başlangıç tarihinden sonra olmalıdır.
              </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    baslangicInput.addEventListener('change', function() {
        if (baslangicInput.value) {
            bitisInput.setAttribute('min', baslangicInput.value);
        }
    });
});
</script>
