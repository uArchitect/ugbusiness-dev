...
<div class="name text-bold"><?=$kullanici->kullanici_ad_soyad?></div>
  ...
  <div class="d-flex"> <a href="https://wa.me/9<?=str_replace(" ","",$kullanici->kullanici_bireysel_iletisim_no)?>" class="media-icons text-primary" style="background: #22b100;color: #ffffff !important;border-radius: 5px;padding: 5px 5px;padding: 5px 10px;margin-right: 5px;">
