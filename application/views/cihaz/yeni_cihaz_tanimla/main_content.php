...
<div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Cihaz Tanımlama Formu</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="<?=base_url()?>">Giriş</a></li>
              <li class="breadcrumb-item active">Cihaz Tanımlama Formu</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
...
<div class="card card-primary">
    ...
    margin-right: 4px;
    color: #f5a100;
"></i> Sipariş kaydı seçilmezse sistem otomatik olarak yeni sipariş oluşturup, bilgileri girilen cihazı o siparişe tanımlar.</span>
 </div>
