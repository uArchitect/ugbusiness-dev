<div class="content-wrapper" style="padding: 20px; background-color: #f8f9fa;">
  <section class="content">
    <div class="card shadow-lg" style="border-radius: 15px; overflow: hidden; max-width: 600px; margin: auto;">
      <div class="card-header bg-dark text-white text-center py-4" style="border-bottom: none;">
        <h3 class="card-title m-0" style="font-size: 28px; font-weight: 600; letter-spacing: 1.5px;">ATIŞ YÜKLEME ONAYI</h3>
      </div>
      <div class="card-body text-center p-5">
        <div class="mb-4 border border-light" style="width: -webkit-fill-available;">
          <img class="img-fluid   p-2" src="<?=$cihaz->urun_png_gorsel?>" style="width: 130px; height: 170px; object-fit: cover; box-shadow: 0 8px 16px rgba(0,0,0,0.15);" alt="Cihaz Görseli">
        </div>
        ...
        <div class="info-box bg-light border-left border-warning text-warning mb-4" style="display: block; text-align: left;padding: 15px; border-radius: 8px; border-width: 4px !important;">
          <h4 class="m-0" style="font-size: 20px; font-weight: 600;">BORÇ UYARI NOTU</h4>
        ...
        <?php if (empty($cihaz->borclu_aciklama)): ?>
        <div class="info-box bg-light border-left border-warning text-warning mb-4" style="display: block; text-align: left;padding: 15px; border-radius: 8px; border-width: 4px !important;">
          <h4 class="m-0" style="font-size: 20px; font-weight: 600;">SİSTEMDE KAYITLI DEĞİL</h4> 
