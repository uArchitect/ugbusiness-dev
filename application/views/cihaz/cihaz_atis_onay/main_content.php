...
<path d="M15 3C16.5315 3.17014 17.9097 3.91107 19 5C20.0903 6.08893 20.8279 7.46869 21 9M14.5 6.5C15.2372 6.64382 15.9689 6.96892 16.5 7.5C17.0311 8.03108 17.3562 8.76284 17.5 9.5M8.20049 15.799C1.3025 8.90022 2.28338 5.74115 3.01055 4.72316C3.10396 4.55862 5.40647 1.11188 7.87459 3.13407C14.0008 8.17945 6.5 8 11.3894 12.6113C16.2788 17.2226 15.8214 9.99995 20.8659 16.1249C22.8882 18.594 19.4413 20.8964 19.2778 20.9888C18.2598 21.717 15.0995 22.6978 8.20049 15.799Z" stroke="#000000" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
  ...
  <?php endif; ?>
        ...
        <div class="mt-0">
         ...
         if($onaylandi == false){
          ?>
          <a href="<?=base_url("api/cihaz_atis_genel_mudur_onay/$serino/1?securitykey=9cdd1a22ab314caa8515393cb6b93938")?>" class="btn btn-warning btn-lg py-3  shadow-sm" style="width: -webkit-fill-available;font-size: 22px; font-weight: 600; letter-spacing: 1px; transition: all 0.3s ease;   border-radius: 5px 5px 10px 10px;">
            ATIŞ YÜKLEME ONAYI VER
          </a>
          <?php
         }else{
?>
    <a  class="btn btn-success btn-lg py-3  shadow-sm" style="width: -webkit-fill-available;font-size: 22px; font-weight: 600; letter-spacing: 1px; transition: all 0.3s ease; background-color: #28a745; border-color: #28a745; border-radius: 5px 5px 10px 10px;">
                ATIŞ YÜKLEME ONAYI VERİLDİ
              </a>
              <a href="<?=base_url("api/cihaz_atis_genel_mudur_onay/$serino/2?securitykey=9cdd1a22ab314caa8515393cb6b93938")?>" class="btn btn-danger btn-lg py-3  shadow-sm mt-2" style="width: -webkit-fill-available;font-size: 22px; font-weight: 600; letter-spacing: 1px; transition: all 0.3s ease;   border-radius: 5px 5px 10px 10px;">
