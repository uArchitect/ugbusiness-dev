<div class="content-wrapper" style=" padding-top:5px; background-color: #f8f9fa;">
 ...
 <?php endif; ?>
  ...
  <?php if (!empty($cihaz->musteri_ad)): ?>
        <div class="info-box bg-light border-left border-right border-primary text-warning  mb-1" style="display: block; text-align: left;padding: 15px; border-radius: 8px; border-width: 4px !important;">
