...
"><?=$value->musteri_ad?><br><?=$value->musteri_iletisim_numarasi?></span>
          ...
          foreach ($urunlerdata as $ur) {
            echo "<div style='".($ur->yenilenmis_cihaz_mi == 1?"background:#dbffe2;":"")."border: 1px solid #d3d3d3; margin-bottom: 5px; border-radius: 4px; padding: 5px; margin-left: -3px; margin-right: -3px;'>";
           
            echo "<b>".$ur->urun_adi." (".$ur->renk_adi.")</b>".($ur->yenilenmis_cihaz_mi == 1 ? "<span class='bg-success  ' style='display: block; padding: 5px; text-align:center;  border-radius: 7px;'>Yenilenmiş Cihaz</span>" : "")."<br>".($ur->seri_numarasi != "" ? $ur->seri_numarasi : "<span style='opacity:0.5'>Seri numarası atanmadı...</span>")."<br>";
      ...
      echo "</div>";
          ...
          <a  target="_blank"  href="<?=base_url("kullanici/profil_new/$value->kullanici_id"."?subpage=ozluk-dosyasi")?>" class="btn btn-outline-primary btn-sm mb-1" style="
