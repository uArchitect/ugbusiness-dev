...
"><?=$value->musteri_ad?><br><?=$value->musteri_iletisim_numarasi?></span>
          ...
          foreach ($urunlerdata as $ur) {
            echo "<b>".$ur->urun_adi." (".$ur->renk_adi.")</b>".($ur->yenilenmis_cihaz_mi == 1 ? "<span class='bg-success yanipsonenyazifooter ' style='display: block; padding: 5px; border-radius: 7px;'>Yenilenmiş Cihaz</span>" : "")."<br>".$ur->seri_numarasi."<br>";
          }
          ?>
          </div>
...
"><?=$value->musteri_ad?><br><?=$value->musteri_iletisim_numarasi?></span></h3>
          ...
          $urunlerdata = get_siparis_urunleri($value->siparis_id);
          foreach ($urunlerdata as $ur) {
            echo "<b>".$ur->urun_adi." (".$ur->renk_adi.")</b>".($ur->yenilenmis_cihaz_mi == 1 ? "<span class='bg-success  ' style='display: block; padding: 5px; border-radius: 7px;'>Yenilenmiş Cihaz</span>" : "")."<br>".$ur->seri_numarasi."<br>";
          }
          ?>
          </div>
