                 ...
                 <div class="card card-dark" style="    height: 100%;">
                   ...
                   <div class="card-body" style="height:470px">
                    ...
                    foreach ($data as $d) {
                      ...
                      ?>
 <div class="row">
                       <div class="col mb-2" style="<?=($d->guncelleme_notu != "") ? "border-radius:5px;border:2px solid red;":"border:1px solid gray;border-radius:3px;"?>padding-left: 0px;margin-right: -1px; margin-top: -1px;    height: 77px;">
