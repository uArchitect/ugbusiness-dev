...
<?php if($guncel_adim == 7) : ?>
  ...
  <select class="select2bs4" style="width: 100%;" name="kontrol_1_select">
...
Acil Button Kontrolü Yapıldı Mı ?
  <select class="select2bs4" style="width: 100%;" name="kontrol_2_select">
    <option>SEÇİM YAPINIZ</option>
    <option value="1">KONTROL EDİLDİ</option>
</select>
</div>
...
Fiş Tipi Kontrolü Yapıldı Mı?
  <select class="select2bs4" style="width: 100%;" name="kontrol_3_select">
    <option>SEÇİM YAPINIZ</option>
    <option value="1">KONTROL EDİLDİ</option>
</select>
...
Kullanım Kılavuzu Kontrolü Yapıldı Mı?
  <select  class="select2bs4" style="width: 100%;" name="kontrol_4_select">
    <option>SEÇİM YAPINIZ</option>
    <option value="1">KONTROL EDİLDİ</option>
</select>
