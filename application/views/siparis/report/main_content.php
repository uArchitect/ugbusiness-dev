...
<label for="" style="display: block;color:red">Siparişe Yeni Cihaz Ekle</label>
                    <a href="<?=base_url("siparis/siparise_urun_ekle/$siparis->siparis_id/8")?>" type="button" class="btn btn-default"><i class="fa fa-plus-circle text-success"></i> Umex Plus</button>
                    <a href="<?=base_url("siparis/siparise_urun_ekle/$siparis->siparis_id/1")?>" type="button" class="btn btn-default"><i class="fa fa-plus-circle text-success"></i> Umex Lazer</button>
                    <a href="<?=base_url("siparis/siparise_urun_ekle/$siparis->siparis_id/5")?>" type="button" class="btn btn-default"><i class="fa fa-plus-circle text-success"></i> Umex Slim</button>
                    <a href="<?=base_url("siparis/siparise_urun_ekle/$siparis->siparis_id/3")?>" type="button" class="btn btn-default"><i class="fa fa-plus-circle text-success"></i> Umex EMS</button>
                    <a href="<?=base_url("siparis/siparise_urun_ekle/$siparis->siparis_id/7")?>" type="button" class="btn btn-default"><i class="fa fa-plus-circle text-success"></i> Umex Q</button>
                    <a href="<?=base_url("siparis/siparise_urun_ekle/$siparis->siparis_id/6")?>" type="button" class="btn btn-default"><i class="fa fa-plus-circle text-success"></i> Umex S</button>
                    <a href="<?=base_url("siparis/siparise_urun_ekle/$siparis->siparis_id/4")?>" type="button" class="btn btn-default"><i class="fa fa-plus-circle text-success"></i> Umex Gold</button>
                    <a href="<?=base_url("siparis/siparise_urun_ekle/$siparis->siparis_id/2")?>" type="button" class="btn btn-default"><i class="fa fa-plus-circle text-success"></i> Umex Diode</button>
