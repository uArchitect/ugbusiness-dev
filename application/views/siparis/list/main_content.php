    ...
    <table id="onaybekleyensiparisler" class="table table-bordered table-striped nowrap">
      ...
      <?php $count=0; foreach ($onay_bekleyen_siparisler as $siparis) : ?>
        ...
        <tr onclick="location.href='<?=$link?>';" style="cursor:pointer;">
          ...
          <td>
            <b><i class="far fa-building" style="color: green;"></i> <?=($siparis->merkez_adi == "#NULL#") ? "<span class='badge bg-danger' style='background: #ffd1d1 !important; color: #b30000 !important; border: 1px solid red;'><i class='nav-icon 	fas fa-exclamation-circle text-danger'></i> Merkez Adı Girilmedi</span>":$siparis->merkez_adi?> </b>   <br>  <?=$siparis->sehir_adi?> / <?=$siparis->ilce_adi?> 
          </td>           
          <td>
            <b>
