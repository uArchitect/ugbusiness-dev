  ...
  background-color: #0552aa;
    ...
    <div class="row" id="sortable-list">
      <?php foreach ($kullanicilar as $kullanici) : ?>
        <div class="card2" style="<?=$kullanici->kullanici_aktif == 0 ? "background:red;color: white !important;  " : ""?>width: calc(100% / <?=$kullanici->kullanici_liste_boyut?> - 10px);" data-id="<?= $kullanici->kullanici_id ?>" data-name="<?= mb_strtolower(str_replace("İ","i",$kullanici->kullanici_ad_soyad), 'UTF-8') ?>">
          <div class="content">
            <div class="img">
