  ...
  <section class="col-lg-12 connectedSortable pl-0">
    ...
    <div class="row" id="sortable-list">
      <?php foreach ($kullanicilar as $kullanici) : ?>
        <div class="card2" data-id="<?= $kullanici->kullanici_id ?>" data-name="<?= ($kullanici->kullanici_ad_soyad == "İbrahim Bircan") ? "ibrahim bircan" : mb_strtolower($kullanici->kullanici_ad_soyad, 'UTF-8') ?>">
          <div class="content">
            <div class="img">
