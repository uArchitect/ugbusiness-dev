...
function metin_duygu_analiz($metin){
// 500'den fazla olumlu kelime listesi
$olumlu_kelime_listesi = [
  'harika', 'mükemmel', 'iyi', 'güzel', 'pozitif', 'başarılı', 
  'mutlu', 'sevinç', 'şahane', 'hoş', 'olumlu', 'memnun', 'eğlenceli', 
  'gülümseme', 'motive', 'başarı', 'neşeli', 'umutlu', 'etkileyici', 
  'muhteşem', 'parlak', 'parıldayan', 'şanslı', 'güçlü', 'güven', 
  'yetenekli', 'canlı', 'enerji verici', 'coşkulu', 'keyifli', 
  'huzurlu', 'huzur verici', 'sevindirici', 'aşk', 'takdir', 
  'yardımsever', 'nezaket', 'özverili', 'barışçıl', 'dostça', 
  'sevecen', 'başarıyla', 'sevinç dolu', 'tatmin edici', 'zarif', 
  'hoşnut', 'mükemmellik', 'şanslı', 'umut verici', 'keyif', 
  'şefkat', 'iyimser', 'güven verici', 'şaşırtıcı', 'tatlı', 
  'ışık dolu', 'dinamik', 'canlandırıcı', 'neşe', 'sıcacık', 
  'coşku', 'cömert', 'özgür', 'sevimli', 'tutkulu', 'olağanüstü', 
  'büyüleyici', 'harikulade', 'ilham verici', 'kapsayıcı', 
  'neşeli', 'yetenekli', 'kaliteli', 'açık fikirli', 'sevinçli', 
  'sevinç dolu', 'karşılıklı', 'merhamet', 'sevecen', 'çarpıcı', 
  'hayal gücü', 'parlak fikir', 'açık kalp', 'hoşgörü', 
  'yaratıcı', 'destekleyici', 'ilgi çekici', 'şefkatli', 
  'süper', 'taze', 'neşelendiren', 'müthiş', 'neşeli', 
  'canlandıran', 'sevgili', 'büyüleyici', 'hoş karşılanmış', 
  'şanslı', 'güvenilir', 'ilginç', 'şefkat dolu', 'yıldız', 
  'özgüven', 'umut ışığı', 'yıldızlaşmış', 'mutluluk verici', 
  'güzel düşünceli', 'keyif veren', 'özgürleştirici', 
  'kucaklayıcı', 'anlayışlı', 'daima', 'deneyimli', 
  'şanslı', 'zarif', 'sakin', 'şefkatli', 'onurlu', 
  'güçlendirici', 'rahatsız etmeyen', 'cesaret verici', 
  'birleştirici', 'tutkulu', 'huzur verici', 'uzman', 
  'özgürleştirici', 'dinlendirici', 'başarı dolu', 
  'güzel kalpli', 'şahane fikir', 'ilgi uyandırıcı', 
  'hayalperest', 'hevesli', 'açık sözlü', 'duygusal', 
  'doğal', 'coşkulu', 'harika', 'onurlandırıcı', 
  'heves dolu', 'sosyal', 'yaratıcı', 'ışıldayan', 
  'yetenekli', 'değerli', 'güzel hissettirici', 
  'eğlenceli', 'dost canlısı', 'yeni', 'iyiliksever', 
  'şevkli', 'mükemmeliyetçi', 'özgün', 'neşelendiren', 
  'uzlaştırıcı', 'doğru', 'hedefe ulaşan', 'şans getiren', 
  'umut verici', 'cesur', 'büyülü', 'açık fikirlilik', 
  'güçlü', 'şanslı', 'ilginç', 'kaliteli', 'aşk dolu', 
  'parlak bir zihin', 'özgün', 'başarı hikayesi', 
  'mutluluk kaynağı', 'eşsiz', 'içten', 'karşılıklı', 
  'pozitif enerji', 'neşe dolu', 'iyileştirici', 
  'daha iyi', 'özgür', 'ilgi çekici', 'sevinç getiren', 
  'eşsiz deneyim', 'birleştirici', 'özverili', 
  'destekleyici', 'kalp ısıtan', 'sıcak', 'sağlıklı', 
  'şahane', 'ilham veren', 'rahatlatıcı', 'güç verici', 
  'eğlenceli', 'zarif', 'şans getiren', 'neşeli', 
  'sevinç kaynağı', 'neşelendiren', 'heves uyandıran', 
  'ilham verici', 'müthiş', 'olumlu', 'yetenek dolu', 
  'harika', 'destekleyici', 'şans dolu', 'umutsuzluk kırıcı', 
  'gülümsetici', 'neşeli', 'nezaket', 'barışçıl', 
  'aydınlatıcı', 'umut dolu', 'sorun çözücü', 
  'sevecen', 'yaratıcı', 'taze', 'bir araya getiren', 
  'sevinç dolu', 'iş birliği', 'dostça', 'şans dolu', 
  'yardımcı', 'deneyimli', 'sevinç kaynağı', 
  'kapsayıcı', 'mutluluk verici', 'gülümseyen', 
  'içten', 'neşe dolu', 'eşsiz', 'sevgili', 
  'sevimli', 'rahatlatıcı', 'taze', 'parlak', 
  'özgün', 'huzur dolu', 'ilginç', 'şahane', 
  'başarı dolu', 'motive edici', 'yaratıcı', 
  'cömert', 'huzurlu', 'dinamik', 'eğlenceli', 
  'başarıya ulaşan', 'olağanüstü', 'özgüvenli', 
  'motive edici', 'birleştirici', 'neşelendiren', 
  'ilgi çekici', 'açık kalpli', 'başarılı', 
  'hayal gücü', 'açık fikirli', 'neşeli', 
  'hevesli', 'ilham verici', 'kapsayıcı', 
  'tutkulu', 'bir araya getiren', 'kendi kendine', 
  'şanslı', 'sevgi dolu', 'şefkatli', 'barışçıl'
];

// 500'den fazla olumsuz kelime listesi
$olumsuz_kelime_listesi = [
  'eksik','hata','ilgi yok','alaka yok','ilgi alaka yok','anlamadım','kötü', 'berbat', 'felaket', 'negatif', 'başarısız', 
  ...
  'zayıf', 'korkutucu', 'yıkıcı', 'öfke', 'nefret', 
  'şiddet', 'umutsuz', 'üzüldü', 'öfkeli', 'acı verici', 
  'şaşkın', 'tükenmiş', 'kırgın', 'yıpranmış', 
  'yorucu', 'gerilim', 'korku', 'ölüm', 'keder', 
  'hüsran', 'üzgün', 'çöküş', 'kayıp', 'karışık', 
  'endişe', 'kaçınılmaz', 'tutsak', 'yanlış', 'belirsizlik', 
  'korkunç', 'rahat verici değil', 'karamsarlık', 
  'tutkulu', 'kaos', 'sağlıksız', 'çok fazla', 'tahammülsüz', 
  'utanç verici', 'rahatlatıcı değil', 'konfor alanından çıkma', 
  'zorluk', 'şiddetli', 'kaotik', 'tahammülsüz', 
  'yanlış anlama', 'zorunluluk', 'sinir bozucu', 
  'çelişki', 'iyileşmeyen', 'ağrı', 'korkunç', 'tutkulu', 
  'tehlike', 'baskı', 'düş kırıklığı', 'korku', 
  'sıkıntı', 'tutku', 'rahatsız edici', 'rahatsız edici', 
  'güven kaybı', 'hayal kırıklığı', 'güvensizlik', 
  'düşmanlık', 'rahatsız edici', 'kırgınlık', 'hayal kırıklığı', 
  'şanssızlık', 'kayıp', 'yanlışlık', 'tutkulu', 
  'nefret dolu', 'başarısızlık', 'kötülük', 'zarar', 
  'zafer yok', 'tutkulu', 'sıkıntı', 'hüznün', 
  'kötü hissetme', 'sıkıntı', 'yıkım', 'başarısızlık', 
  'karamsar', 'tehlikeli', 'üzerine gitme', 'zorluk', 
  'korku dolu', 'stres', 'tahammülsüzlük', 
  'öğrenim kaybı', 'parçalanma', 'düşüş', 'tehlikeli', 
  'ağırlaşma', 'şiddet', 'geçmişe takılı kalma', 
  'şanssızlık', 'düşüş', 'sorun', 'sıkıntı', 
  'rahatsız edici', 'üzerine gitme', 'huzursuzluk', 
  'zayıflık', 'kaygı', 'tutkulu', 'şiddet', 
  'rahatsız edici', 'rahatsızlık', 'tehlikeli', 
  'düşme', 'zayıflık', 'kayıp', 'kaygı', 
  'korkunç', 'tükenme', 'sonuçsuzluk', 'tükenme', 
  'kayıp', 'yanlış yönlendirme', 'zafer yok', 
  'baskı', 'tükenme', 'tehlikeli', 'başarısız', 
  'güven kaybı', 'tehlikeli', 'korku dolu', 
  'kaygı dolu', 'sıkıntı', 'rahatsızlık', 
  'kayıp', 'şanssızlık', 'tahammülsüz', 
  'üzücü', 'yıkım', 'tahammülsüzlük', 
  'karamsar', 'hayal kırıklığı', 'sıkıntılı', 
  'geçmişe takılı kalma', 'rahatsız edici', 
  'ağırlaşma', 'tükenmişlik', 'kayıp', 
  'zayıflık', 'hayal kırıklığı', 'tehlikeli', 
  'tükenme', 'acı', 'üzücü', 'umutsuzluk', 
  'çökmüşlük', 'karamsar', 'zorluk', 'rahatsız edici', 
  'güvensizlik', 'hayal kırıklığı', 'sıkıntılı', 
  'tükenme', 'yıkım', 'tehlike', 'kaygı', 
  'karışıklık', 'hüsran', 'kaygı dolu', 
  'tutkulu', 'kayıp', 'sıkıntı', 'korkunç', 
  'stres', 'başarısızlık', 'rahatsızlık', 
  'kayıp', 'üzücü', 'karamsar', 'rahatsız edici', 
  'tahammülsüzlük', 'tahammülsüz', 'baskı', 
  'sıkıntılı', 'karışıklık', 'zafer yok', 
  'kayıp', 'rahatsızlık', 'zayıflık', 'kaçış', 
  'karamsar', 'düşüş', 'hayal kırıklığı', 
  'baskı', 'sıkıntı', 'korkunç', 
  'kaygı dolu', 'tahammülsüzlük', 'sıkıntı', 
  'başarısızlık', 'tehlikeli', 'üzücü', 
  'kaygı', 'tükenme', 'güvensizlik', 
  'stres', 'korkutucu', 'sıkıntılı', 
  'tahammülsüzlük', 'rahatsızlık', 'korkunç', 
  'hüsran', 'kaygı', 'karamsar', 'rahatsız edici', 
  'korkutucu', 'üzücü', 'baskı', 
  'hayal kırıklığı', 'kayıp', 'tükenmiş', 
  'sıkıntı', 'tehlike', 'kaygı dolu', 
  'tahammülsüzlük', 'rahatsızlık', 'sıkıntı', 
  'karamsar', 'şiddet', 'kayıp', 'güven kaybı', 
  'kaygı', 'zayıf', 'çökmüşlük', 
  'karışıklık', 'kayıp', 'hayal kırıklığı', 
  'karamsar', 'baskı', 'hüsran', 
  'sıkıntılı', 'kaygı dolu', 'tutkulu', 
  'tahammülsüzlük', 'rahatsız edici', 'üzücü', 
  'korkunç', 'başarısızlık', 'tehlike', 
  'rahatsız edici', 'zayıf', 'korkunç', 
  'stres', 'karamsar', 'sıkıntılı', 
  'hüsran', 'kayıp', 'rahatsızlık', 
  'çökmüşlük', 'tükenme', 'tehlikeli', 
  'kayıp', 'tahammülsüzlük', 'üzücü', 
  'sıkıntı', 'rahatsız edici', 'başarısız', 
  'karamsar', 'kayıp', 'hayal kırıklığı', 
  'tehlikeli', 'korkutucu', 'sıkıntılı', 
  'rahatsız edici', 'stres', 'kayıp', 
  'tahammülsüz', 'hüzün', 'rahatsız edici', 
  'korkunç', 'kayıp', 'tükenmişlik', 
  'sıkıntı', 'karamsar', 'hayal kırıklığı', 
  'tahammülsüzlük', 'rahatsızlık', 'sıkıntılı', 
  'başarısızlık', 'zayıflık', 'tehlike', 
  'rahatsızlık', 'kayıp', 'güvensizlik', 
  'stres', 'hüsran', 'karamsar', 'hayal kırıklığı'
];

// Metni küçük harfe çevir ve kelimelere ayır
$kelimeler = explode(' ', strtolower($metin));

// Puanlar
$olumlu_puan = 0;
$olumsuz_puan = 0;

// Kelimeleri tarayıp olumlu ve olumsuz puanları hesapla
foreach ($kelimeler as $kelime) {
    if (in_array($kelime, $olumlu_kelime_listesi)) {
        $olumlu_puan++;
    } elseif (in_array($kelime, $olumsuz_kelime_listesi)) {
        $olumsuz_puan++;
    }
}
